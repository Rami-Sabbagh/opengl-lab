...
كتابة توابع لإنشاء اسطوانة ومخروط
ومن ثمّ تعديل استدعاء التابع ليصبح لدينا موشور وهرم رباعي
*/
...
class DrawModeApplication : public LabUtils::LabOrbitApplication
{
	...
	*/
	...
	void onInit() override
	{
		...
		// TASK: غيّر المعطيات المناسبة لجعل الاسطوانة موشور، وجعل المخروب هرماً رباعي
...
int main() {
	...
	app.run({ 600, 600 }, "Homework - Cylinder & Cone (H01:P01)");
